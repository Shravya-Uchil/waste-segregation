...
PATH = os.getcwd()
images_path = PATH + '/data_aug'
types = ['cardboard_aug', 'glass_aug', 'metal_aug', 'paper_aug', 'plastic_aug', 'trash_aug']
...
model.compile(loss='categorical_crossentropy',c
...
new_img = cv2.imread(images_path + '/trash_aug/_10_5111875.png')
...
new_img = cv2.imread(images_path + '/plastic_aug/_24_1575208.png')
...
new_img = cv2.imread(images_path + '/cardboard_aug/_43_2330194.png')
...
new_img = cv2.imread(images_path + '/glass_aug/_28_2221118.png')
...
new_img = cv2.imread(images_path + '/paper_aug/_60_8721308.png')
...
new_img = cv2.imread(images_path + '/metal_aug/_60_2657853.png')
